...
SECRET_KEY = '1mz6wv*0mo37ehp0oc(q-q0cbndwddr3ix)l0b%p$r3*!pje5e'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media', # 注册MEDIA_URL标签，使得模板可以使用
            ],
        },
    },
]
...
USE_TZ = False # 这样在数据库中存的就是本地时间，而不是UTC
